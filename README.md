...
A Multi-Agent AI Automation System built with n8n that delivers personalized fitness and nutrition assistance through specialized AI Agents.

## Features

- Multi-Agent AI Architecture
- Supervisor Agent for intelligent task routing
- Dedicated Workout AI Agent
- Dedicated Diet AI Agent
- Voice message support
- Image analysis for food recognition
- Image analysis for gym equipment
...
The Diet Agent focuses only on nutrition.
